...
const Footer = () => {
  return (
    <div className='flex flex-col md:flex-row items-center justify-center   bg-green-500 h-30 text-center text-sm md:text-xl  lg:text-2xl text-white pt-10 font-bold pb-5'>
        <div>
            this website is Created by <span className='text-black'>@Ahmed Abdelhalem</span>
        </div>
        <div className='flex justify-center mt-5 space-x-2 ml-15 mb-5 text-xl'> 
